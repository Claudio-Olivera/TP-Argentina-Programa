...
(1,1,'Juan', 'Argentina', NULL, NULL,'x', 'Arabia Saudita'),
(1,2,'Juan', 'Polonia', NULL, 'x', NULL, 'Mexico'),
(1,3,'Juan', 'Argentina', 'x', NULL, NULL, 'Mexico'),
(1,4,'Juan', 'Arabia Saudita', NULL, NULL, 'x', 'Polonia'),
(1,5,'Juan', 'Argentina',NULL, NULL, 'x', 'Polonia'),
(1,6,'Juan', 'Arabia Saudita',NULL, NULL, 'x', 'Mexico'),
...
(1,1,'Jimena', 'Argentina',NULL , NULL, 'x', 'Arabia Saudita'),
...
(2,7,'Juan', 'Argentina', NULL, NULL,'x', 'Arabia Saudita'),
(2,8,'Juan', 'Polonia', NULL, 'x', NULL, 'Mexico'),
(2,9,'Juan', 'Argentina', 'x', NULL, NULL, 'Mexico'),
(2,10,'Juan', 'Arabia Saudita', NULL, NULL, 'x', 'Polonia'),
(2,11,'Juan', 'Argentina',NULL, NULL, 'x', 'Polonia'),
(2,12,'Juan', 'Arabia Saudita',NULL, NULL, 'x', 'Mexico'),
